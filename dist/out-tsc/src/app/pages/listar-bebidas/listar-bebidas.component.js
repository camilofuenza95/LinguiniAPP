...
var ListarBebidasComponent = /** @class */ (function () {
    function ListarBebidasComponent(alertController, service, router, productService, cartService, activedRoute, ev) {
    ...
    ListarBebidasComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ListarBebidasComponent.prototype.showProductByCatId = function (cat_id) {
    ...
    Object.defineProperty(ListarBebidasComponent.prototype, "isSkeleton", {
        set: function (val) {
    ...
    //}
    ListarBebidasComponent.prototype.addToCart = function (pObj, index) {
        this.cartService.addToCart(pObj, index);
    };
    ListarBebidasComponent.prototype.LessOneItem = function (pObj, index) {
        this.cartService.removeOneProduct(pObj, index);
    };
    ListarBebidasComponent.prototype.presentAlert = function () {
    ...
    ListarBebidasComponent.prototype.registrarOrden = function (carta) {
        var _this = this;
    ...
    ], ListarBebidasComponent.prototype, "isSkeleton", null);
    ListarBebidasComponent = tslib_1.__decorate([
        Component({
    ...
    return ListarBebidasComponent;
}());
export { ListarBebidasComponent };
//# sourceMappingURL=listar-bebidas.component.js.map