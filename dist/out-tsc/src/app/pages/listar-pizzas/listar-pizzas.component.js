...
var ListarPizzasComponent = /** @class */ (function () {
    function ListarPizzasComponent(alertController, service, router, productService, cartService, activedRoute, ev) {
    ...
    ListarPizzasComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ListarPizzasComponent.prototype.showProductByCatId = function (cat_id) {
    ...
    Object.defineProperty(ListarPizzasComponent.prototype, "isSkeleton", {
        set: function (val) {
    ...
    //}
    ListarPizzasComponent.prototype.addToCart = function (pObj, index) {
        this.cartService.addToCart(pObj, index);
    };
    ListarPizzasComponent.prototype.LessOneItem = function (pObj, index) {
        this.cartService.removeOneProduct(pObj, index);
    };
    ListarPizzasComponent.prototype.presentAlert = function () {
    ...
    ListarPizzasComponent.prototype.registrarOrden = function (carta) {
        var _this = this;
    ...
    ], ListarPizzasComponent.prototype, "isSkeleton", null);
    ListarPizzasComponent = tslib_1.__decorate([
        Component({
    ...
    return ListarPizzasComponent;
}());
export { ListarPizzasComponent };
//# sourceMappingURL=listar-pizzas.component.js.map