...
var ListarCervezasComponent = /** @class */ (function () {
    function ListarCervezasComponent(alertController, service, router, productService, cartService, activedRoute, ev) {
    ...
    ListarCervezasComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getCervezas()
    ...
    ListarCervezasComponent.prototype.showProductByCatId = function (cat_id) {
    ...
    Object.defineProperty(ListarCervezasComponent.prototype, "isSkeleton", {
        set: function (val) {
    ...
    //}
    ListarCervezasComponent.prototype.addToCart = function (pObj, index) {
        this.cartService.addToCart(pObj, index);
    };
    ListarCervezasComponent.prototype.LessOneItem = function (pObj, index) {
        this.cartService.removeOneProduct(pObj, index);
    };
    ListarCervezasComponent.prototype.presentAlert = function () {
    ...
    ListarCervezasComponent.prototype.registrarOrden = function (carta) {
        var _this = this;
    ...
    ], ListarCervezasComponent.prototype, "isSkeleton", null);
    ListarCervezasComponent = tslib_1.__decorate([
        Component({
            selector: 'app-listar-cervezas',
            templateUrl: './listar-cervezas.component.html',
            styleUrls: ['./listar-cervezas.component.scss'],
        }),
    ...
    return ListarCervezasComponent;
}());
export { ListarCervezasComponent };
//# sourceMappingURL=listar-cervezas.component.js.map