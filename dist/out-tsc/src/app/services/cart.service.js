...
var CartService = /** @class */ (function () {
    ...
    //-------------Add To Cart--------------------------------
    CartService.prototype.addToCart = function (OrProduct, index) {
    ...
    CartService.prototype.addOneProduct = function (product) {
    ...
    //-----------Remvoe One Product-----------------------------
    CartService.prototype.removeOneProduct = function (OrProduct, ind) {
        var product;
        var Tmpproduct = JSON.parse(JSON.stringify(OrProduct));
    ...
    ;
    //---------------------------------------------
    CartService.prototype.getCartData = function () { return this.cartData.products; };
    CartService.prototype.getItemTotal = function () { return this.cartData.products.length; };
    ...
    //---------------------------------------------
    CartService.prototype.restCartProducts = function (productData) {
        var cartData = [];
        ...
        if (cartData.length) {
            cartData.forEach(function (prod, index) {
                var pobj = productData.filter(function (item) { return item.id == prod.id; })[0];
                //console.log("prod ",prod)
                if (pobj) {
                    if (pobj.rec_attr.length) {
                        var ival = prod.attrline[0].i;
    ...
    //---------------------------------------------
    CartService.prototype.formatTotal = function (total) {
        // return total.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
        return total.toFixed(2);
    };
    CartService.prototype.formatedPrice = function (total) {
